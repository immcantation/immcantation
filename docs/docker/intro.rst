...
**For tutorial purposes**, use immcantation/lab (be sure to replace ``suite`` with ``lab`` in the following code chunks) and follow the directions :ref:`here <Using the container for tutorials> `. For all Immcantation uses, use immcantation/suite.
