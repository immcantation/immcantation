...
Usage:
python format_citations.py -i immcantation_citations.tsv -o ../citedby.rst
...
def create_rst_output(df, output_file, download_date):
...
def main():
    ...
    try:
        ...
        create_rst_output(df_sorted, output_file_rst, download_date)
