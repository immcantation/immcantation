...
knitr::opts_chunk$set(echo = TRUE, fig.path=file.path("intro-lab_files","intro-lab_"))
```
...
You can download the example data from Zenodo. It is alreday available in the container: 
...
```{r intra-inter-clonal-d, message = FALSE, fig.alt='intra-inter-clonal-d'}
...
```{r build-phylip-lineage, fig.alt='build-phylip-lineage'}
