...
You can download the example data from Zenodo [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.10046916.svg)](https://doi.org/10.5281/zenodo.10046916). It is alreday available in the container [Immcantation Lab](https://hub.docker.com/repository/Docker/immcantation/lab): 
...
```{r read-imgt, warning=FALSE, message=FALSE}
...
```{r clonal-consensus, cache.lazy = FALSE}
...
The documentation includes a [bulk tutorial](https://nf-co.re/airrflow/usage/bulk_tutorial) that guides you through the steps of running the workflow for bulk datasets.