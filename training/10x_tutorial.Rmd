...
```{r}
gex_db <- readRDS("assets/GEX.data.rds")
```
...
data_10x_example <- airr::read_rearrangement("../data/10x_data_2subj/sc5p_v2_hs_B_1k_multi_5gex_b_Multiplex_vdj_b_all_contig_igblast_db-pass.tsv")
...
dist_crossSubj <- distToNearest(dplyr::filter(data_both_subjects,
                                              locus == "IGH"),
...
treesToPDF(plots_time, file = "results/dowser_tutorial/time_data_trees.pdf")
