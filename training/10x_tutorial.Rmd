...
# TODO: update path to final path in container
MakeDb.py igblast -i results/BCR_data_sequences_igblast.fmt7 -s /data/filtered_contig.fasta \
...
bcr_data <- airr::read_rearrangement(file.path("assets", "zenodo", "BCR_data.tsv"),
...
gex_db <- readRDS(file.path("assets", "zenodo", "GEX.data_08112023.rds"))
```
