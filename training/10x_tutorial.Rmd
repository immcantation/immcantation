...
knitr::opts_chunk$set(echo=TRUE, cache=params$cache, fig.path=file.path("10x_tutorial_files","10x_tutorial_"))
```
...
* Source code for Immcantation tutorials: <https://bitbucket.org/kleinstein/immcantation/src/master/training/>
...
treesToPDF(plots_all, file = file.path("results", "dowser_tutorial",
                                       "final_data_trees.pdf"),
           nrow = 2, ncol = 2)
```
