...
knitr::opts_chunk$set(echo=TRUE, cache=params$cache, fig.path=file.path("BCR_Seurat_tutorial_files","BCR_Seurat_tutorial_"))
```
...
* **BCR.data_08112023.rds**: R dataframe object containing the single-cell BCR sequencing data for both samples 1 and 2.
