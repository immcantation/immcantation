...
gex_obj
names(gex_obj@commands) # the processing that we did on this data
...
* If the column “contains_bcr” is true, then we can add other useful BCR data information such as clonal lineage, mutation frequency, isotype, etc. to the metadata slot.
...
bcr_data_selected <- dplyr::filter(bcr_data_selected, !is.na(mu_freq))
