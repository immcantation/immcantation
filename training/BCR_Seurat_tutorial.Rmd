...
* The example data is already in the Docker container [Immcantation Lab](https://hub.docker.com/repository/Docker/immcantation/lab) (`/home/magus/data/`). If you want to, you can download it from Zenodo [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.10028129.svg)](https://doi.org/10.5281/zenodo.10028129).
