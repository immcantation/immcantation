...
@test "AlignSets-muscle" {
    ...
    READS="${DATA_DIR}/sequences/HD13M-R1_primers-pass_pair-pass.fastq.gz"
...
@test "AlignSets-table" {
    TEST="${BATS_TEST_NUMBER}-${BATS_TEST_DESCRIPTION}"
    PRIMERS="${DATA_DIR}/primers/AbSeq_R2_TS.fasta.gz"
    LOG="${RUN_DIR}/logs/${TEST}.log"
    CONSOLE="${RUN_DIR}/console/${TEST}.out"
    OUTPUT=$(get_output ${TEST} ${OUTDIR} ${FAILED})
...
@test "AssemblePairs-align" {
    TEST="${BATS_TEST_NUMBER}-${BATS_TEST_DESCRIPTION}"
    READS_1="${DATA_DIR}/sequences/HD13M-R2_consensus-pass_pair-pass.fastq.gz"
    READS_2="${DATA_DIR}/sequences/HD13M-R1_consensus-pass_pair-pass.fastq.gz"
    LOG="${RUN_DIR}/logs/${TEST}.log"
    CONSOLE="${RUN_DIR}/console/${TEST}.out"
    OUTPUT=$(get_output ${TEST} ${OUTDIR} ${FAILED})
...
@test "CollapseSeq" {
    TEST="${BATS_TEST_NUMBER}-${BATS_TEST_DESCRIPTION}"
    READS="${DATA_DIR}/sequences/HD13M-final_total.fastq.gz"
    LOG="${RUN_DIR}/logs/${TEST}.log"
    CONSOLE="${RUN_DIR}/console/${TEST}.out"
    OUTPUT=$(get_output ${TEST} ${OUTDIR} ${FAILED})
...
@test "FilterSeq-maskqual" {
    TEST="${BATS_TEST_NUMBER}-${BATS_TEST_DESCRIPTION}"
    READS="${DATA_DIR}/sequences/HD13M_L001_R1_001.fastq.gz"
    LOG="${RUN_DIR}/logs/${TEST}.log"
    CONSOLE="${RUN_DIR}/console/${TEST}.out"
    OUTPUT=$(get_output ${TEST} ${OUTDIR} ${FAILED})
...
@test "MaskPrimers-extract" {
    TEST="${BATS_TEST_NUMBER}-${BATS_TEST_DESCRIPTION}"
    READS="${DATA_DIR}/sequences/HD13M_L001_R2_001.fastq.gz"
    LOG="${RUN_DIR}/logs/${TEST}.log"
    CONSOLE="${RUN_DIR}/console/${TEST}.out"
    OUTPUT=$(get_output ${TEST} ${OUTDIR} ${FAILED})
...
@test "PairSeq" {
    TEST="${BATS_TEST_NUMBER}-${BATS_TEST_DESCRIPTION}"
    READS_1="${DATA_DIR}/sequences/HD13M-R1_primers-pass.fastq.gz"
    READS_2="${DATA_DIR}/sequences/HD13M-R2_primers-pass.fastq.gz"
    LOG="${RUN_DIR}/logs/${TEST}.log"
    CONSOLE="${RUN_DIR}/console/${TEST}.out"
...
@test "ParseHeaders-collapse-1" {
    TEST="${BATS_TEST_NUMBER}-${BATS_TEST_DESCRIPTION}"
    READS="${DATA_DIR}/sequences/HD13M_assemble-pass.fastq.gz"
    CONSOLE="${RUN_DIR}/console/${TEST}.out"
    OUTPUT=$(get_output ${TEST} ${OUTDIR} ${FAILED})
...
@test "SplitSeq-select" {
    TEST="${BATS_TEST_NUMBER}-${BATS_TEST_DESCRIPTION}"
    READS="${DATA_DIR}/sequences/HD13M-R1_consensus-pass_pair-pass.fastq.gz"
    CONSOLE="${RUN_DIR}/console/${TEST}.out"
    OUTPUT=$(get_output ${TEST} ${OUTDIR} false)
